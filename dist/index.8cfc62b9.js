...
let moment = require("242daad3682361e9");
let now = moment();
...
// Array Method
//chunk
let lodash = require("17e7bfce3a638a93");
let number = [
    1,
    2,
    3,
...
let find = lodash.find(users, function(obj) {
    return obj.age < 30;
});
console.log(find);
// _.map()
...
let ascending = lodash.orderBy(users, [
    "user",
    "age"
], [
    "desc"
...
},{"242daad3682361e9":"jwcsj","17e7bfce3a638a93":"3qBDj"}],"jwcsj":[function(require,module,exports) {
//! moment.js
//! version : 2.30.1
...
},{}]},["hIFAM","6rimH"], "6rimH", "parcelRequire95e1")
